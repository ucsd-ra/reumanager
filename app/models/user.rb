...
class User < ActiveRecord::Base
  ...
  attr_accessible :login, :email, :firstname, :middlename, :lastname, :dob, :street, :city, :state, :zip, :phone, :pstreet, :pcity, :pstate, :pzip, :pphone, :first_gen, :free_lunch, :citizenship, :cresidence, :gender, :ethnicity, :race, :disability, :password, :password_confirmation, :emailed_rejection_letter_at, :emailed_waitlist_letter_at
